...
"""
Module généré automatiquement à partir de section 4.3_module m5pcld.py_Markov d'ordre 5 .docx
----------------------------------------------------------------
...
class ImplementationLotoV4:
    ...
    def analyse_donnees(self, donnees):
        ...
        resultats = {
            ...
            "source_file": "section 4.3_module m5pcld.py_Markov d'ordre 5 .docx",

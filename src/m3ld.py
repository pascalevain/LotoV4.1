...
"""
Module généré automatiquement à partir de Section 4.3 - m3ld.py Chaînes de Markov d'ordre 3.docx
----------------------------------------------------------------
...
class ImplementationLotoV4:
    ...
    def analyse_donnees(self, donnees):
        ...
        resultats = {
            ...
            "source_file": "Section 4.3 - m3ld.py Chaînes de Markov d'ordre 3.docx",
